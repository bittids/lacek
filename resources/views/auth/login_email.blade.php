<!-- Stored in resources/views/auth/login_email.blade.php -->
...
<form method="POST" id="login_form" action="{{ route('auth.post.login-email') }}">
    ...
    <div class="form-outline mb-4">
        <div class="form-group {{ $errors->has('email') ? 'has-error' : ''}}" id="email_group">
            <input id="email" type="text" name="email" value="{{ old('email') }}" class="form-control input-sm" placeholder="your email" />
