...
<form method="POST" id="register_form" action="{{ route('auth.post.register-email') }}">
    ...
    <div class="form-outline mb-4">
        <div class="form-group {{ $errors->has('str_first_name') ? 'has-error' : ''}}" id="str_first_name_group">
            <input id="str_first_name" type="text" name="str_first_name" value="{{ old('str_first_name') }}" class="form-control input-sm" placeholder="your first name" />
    ...
    <!-- start last name -->
    <div class="form-outline mb-4">
        <div class="form-group {{ $errors->has('str_last_name') ? 'has-error' : ''}}" id="str_last_name_group">
            <input id="str_last_name" type="text" name="str_last_name" value="{{ old('str_last_name') }}" class="form-control input-sm" placeholder="your last name" />
    ...
    <div class="form-outline mb-4">
        <div class="form-group {{ $errors->has('email') ? 'has-error' : ''}}" id="email_group">
            <div id="app">
                <input id="email" type="text" name="email" class="form-control input-sm" placeholder="your email" v-model="email" />
    ...
    <!-- start passwrod -->
    <div class="form-outline mb-4">
        <div class="form-group {{ $errors->has('password') ? 'has-error' : ''}}" id="password_group">
            <input id="password" type="password" name="password" value="" class="form-control input-sm" placeholder="your password" />
    ...
    <div class="form-outline mb-4">
        <div class="form-group {{ $errors->has('password') ? 'has-error' : ''}}" id="password_confirmation_group">
            <input id="password_confirmation" type="password" name="password_confirmation" value="" class="form-control input-sm" placeholder="confirm your password" />
    ...
    <button type="button" class="btn btn-primary btn-block mb-4" id="password-show-btn">Show password text
    </button>
