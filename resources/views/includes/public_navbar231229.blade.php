  ...
  <div class="container-fluid">
    <ul class="navbar-nav">
     ...
     <li class="nav-item active">
      ...
      <!--
      <li class="nav-item">
        <a class="nav-link" href="{{ route('posts.get.create_post') }}">Create a post</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="{{ route('posts.get.choose_post') }}">Choose a post - update, delete</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="{{ route('posts.get.view_posts') }}">View all your posts</a>
      </li>  
      <li class="nav-item">
        <a class="nav-link" href="{{ route('comments.get.choose_comment') }}">Choose a comment - update, delete</a>
      </li>  
      <li class="nav-item">
        <a class="nav-link" href="{{ route('comments.get.view_comments') }}">View all your comments</a>
      </li>
-->
