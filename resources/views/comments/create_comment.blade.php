...
<div class="row">
  <div class="col-sm-12">
     The title of the post on which you are making a comment is 
      <br><br>
     {{ $coll_post->str_title  }}
  </div><!-- end col -->
</div><!-- end row dov-->
...
<div class="row">
  <div class="col-sm-12">
  The content of the post on which you are making a comment is 
      <br><br>
     {{ $coll_post->str_post  }}
  </div><!-- end col -->
</div><!-- end row dov-->
...
<div class="row">
  ...
  <!-- Submit button -->
  <button type="submit" class="btn btn-primary btn-block mb-4">Create a comment</button>
